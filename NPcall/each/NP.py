...
def NP_analysis(ch2, ch4, output_wd,
...
path_csv = "{}/grid/channels/{}/heatmap.csv"
path_to_folder = sys.argv[1]
path_to_ch2 = sys.argv[2]
path_to_ch4 = sys.argv[3]
path_to_ann = sys.argv[4]
path_to_output = sys.argv[5]

datapath_ch2 = path_csv.format(path_to_folder, path_to_ch2)
datapath_ch4 = path_csv.format(path_to_folder, path_to_ch4)

ch2 = pd.read_csv(datapath_ch2).loc[:, ['x', 'y', 'mean']]
ch4 = pd.read_csv(datapath_ch4).loc[:, ['x', 'y', 'mean']]

print(ch2.head(3))
print(ch4.shape)
NP_analysis(ch2, ch4, output_wd = path_to_output, ann_path = path_to_ann)
